...
export default function Messages({session}) {
  ...
  let time = split[1].split('.')[0]
	...
	return(
		<div className={`md:w-[78%] overflow-hidden ${revealMenu ? "w-[20%]  transform transition-width duration-500 ease-in-out" : "w-[100%] transform transition-width duration-500 ease-in-out" } min-h-screen relative bg-[#333333]`} >
			<ToastContainer/>
